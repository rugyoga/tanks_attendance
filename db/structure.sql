...
CREATE TABLE "tankers_tanks" ("tank_id" integer NOT NULL, "tanker_id" integer NOT NULL);
CREATE TABLE "tanks" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "tier" integer, "class" varchar(255), "created_at" datetime, "updated_at" datetime);
